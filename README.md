...
spin-vector views. Extended XYZ trajectories are supported out of the box.
...
keeping downstream analysis and plotting independent of input syntax.
...
- values retain their source provenance and are not relabeled as reference data.
